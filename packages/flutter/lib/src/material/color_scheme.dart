...
class ColorScheme with Diagnosticable {
  ...
  factory ColorScheme.fromSeed({
    ...
    final DynamicScheme scheme =
        _buildDynamicScheme(brightness, seedColor, dynamicSchemeVariant);
  ...
  static Future<ColorScheme> fromImageProvider({
    ...
    final DynamicScheme scheme =
        _buildDynamicScheme(brightness, baseColor, dynamicSchemeVariant);
  ...
  static DynamicScheme _buildDynamicScheme(Brightness brightness,
      Color seedColor, DynamicSchemeVariant schemeVariant) {
    final bool isDark = brightness == Brightness.dark;
